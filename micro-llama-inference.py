...
sys.path.append(r"C:\Users\ajste\Documents\Research COde\HE project")

file_name = "cleansedpizan.txt"                   # The file name for local storage
...
MASTER_CONFIG = {
    ...
    'n_heads'       : 8,
    "log_interval"  : 10,
    'n_layers'      : 12,        # Set the number of layers to 12
    'epochs'        : 10000,
...
#generated_texts = generate(llama, MASTER_CONFIG, prompt_text="Who founded carthage", max_new_tokens=300, stream=stream)  # Let the LLM model write the sentence after "ELIZA".
